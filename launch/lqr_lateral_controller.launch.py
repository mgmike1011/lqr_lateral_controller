...
def launch_setup(context, *args, **kwargs):
    ...
    lqr_lateral_controller_node = Node(
        package='lqr_lateral_controller',
        executable='lqr_lateral_controller_node_exe',
        name='lqr_lateral_controller_node',
        parameters=[
            param_path
        ],
        output='screen',
...
def generate_launch_description():
    ...
    add_launch_arg('lqr_lateral_controller_param_file', '')
