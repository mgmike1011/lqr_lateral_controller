...
private:
  ...
  Eigen::RowVector<double, 4> get_K(
...
public:
  ...
  double calculate_control_signal(
    const double & v_x, const double & yaw_des_dot, const double & tp,
    const Eigen::Vector4d & xstate, const double & R, const size_t & index);
};
}  // namespace lqr_lateral_controller
#endif  // LQR_HPP_
